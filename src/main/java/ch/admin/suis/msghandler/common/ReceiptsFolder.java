/*
 * $Id: ReceiptsFolder.java 327 2014-01-27 13:07:13Z blaser $
 *
...
public class ReceiptsFolder extends Mailbox {
	...
	public boolean isConfiguredFor(MessageType type) {
		if (type == null && messageTypes.isEmpty()) {
			return true;
		}

		// search
		for (MessageType messageType : messageTypes) {
			if ((type != null) && (type.getType() == messageType.getType())) {
				return true;
			}
		}
