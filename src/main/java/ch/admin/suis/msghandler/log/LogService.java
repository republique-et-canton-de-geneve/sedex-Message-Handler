/*
 * $Id: LogService.java 327 2014-01-27 13:07:13Z blaser $
 *
...
public interface LogService {
	 ...
	 * @param participantId the ID of the participant application to which the message is sent
	 ...
	 *
	 * @param source         the source of the message (MessageHandler or transparently dispatched)
	 * @param participantIds list of the ID of the participant application to which the message has
	 *                       been sent
	 * @param filename       the name of the sent file
	 * @param messageId      the message ID this file has been packed into
	 * @throws LogServiceException if an underlying problem prevents from properly setting the
	 *                             status
	 */
	 ...
	 *
	 * @param source        the source of the message (MessageHandler or transparently dispatched)
	 * @param participantId the ID of the participant application to which the message has
	 *                      been sent
	 * @param filename      the name of the sent file
	 * @param messageId     the message ID this file has been packed into
	 * @throws LogServiceException if an underlying problem prevents from properly setting the
	 ...
	 * list
	 * @throws LogServiceException if some underlying problem prevents this operation from
	 *                             completion
	 */
	 ...
	 * @param changeDate the status change date
	 ...
	 *
	 * @return List of DB Logs
	 * @throws LogServiceException Log Service Problem
	 */
	 ...
	 * @throws LogServiceException if the internal log DB cannot be accessed for whatever reason
	 */
	 ...
	 *
	 * @param messageId The message ID
	 * @return whether the service is transparent or not.
