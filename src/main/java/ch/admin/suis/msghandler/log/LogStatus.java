...
public enum LogStatus {
  ...
  FORWARDED(3),
  /**
   * the message is received by the recipeient; there is the receipt in the receipts directory of the Sedex adapter
   */
  DELIVERED(4),
  /**
   * the message was not delivered and is expired; there is the receipt in the receipts directory of the Sedex adapter
   */
  EXPIRED(5),
  /**
   * an error is reported by the Sedex adapter; there is the receipt in the receipts directory
   */
  ERROR(8);
