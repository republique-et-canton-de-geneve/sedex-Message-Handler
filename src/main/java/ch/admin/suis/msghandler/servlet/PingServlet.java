...
public class PingServlet extends HttpServlet implements MediaType {
  ...
  private String createFullHtml() {
    ...
    sb.append("<html><body>");
    sb.append(HtmlUtils.addTag("h1", "Alive!"));
    sb.append(createHtmlInfoTable());
    sb.append("</body></html>");
    return sb.toString();
  }
  ...
  private String createHtmlTableEntries(String title, Map<String, String> map) {
    ...
    for(String key : map.keySet()) {
      ...
      sb.append(HtmlUtils.addTag("td", key));
      sb.append(HtmlUtils.addTag("td", map.get(key)));
      sbOuter.append(HtmlUtils.addTag("tr", sb.toString()));
    }
