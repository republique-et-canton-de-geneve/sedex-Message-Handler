...
@XmlType(name = "V2Envelope", propOrder = {
    "messageId",
    "messageType",
    "messageClass",
    "referenceMessageId",
...
public class V2Envelope extends EnvelopeTypeParent implements EnvelopeInterface {
    ...
    protected V2Envelope.Loopback loopback;
     ...
     * @return
     *     possible object is
     *     {@link V2Envelope.Loopback }
     *     
     */
    public V2Envelope.Loopback getLoopback() {
        return loopback;
    }
     ...
     *     
     */
    public void setLoopback(V2Envelope.Loopback value) {
        this.loopback = value;
    }
