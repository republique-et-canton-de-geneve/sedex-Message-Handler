...
public class ReceiverSessionImpl implements ReceiverSession, ClientCommons
{
  ...
  public Collection<IncomingMessage> getNewMessages()
  {
    ...
    ArrayList<IncomingMessage> messages = new ArrayList<IncomingMessage>();
   ...
   *
   * @see ch.admin.suis.msghandler.receiver.ReceiverSession#logSuccess()
   */
  @Override
   ...
   *
   * @see ch.admin.suis.msghandler.receiver.ReceiverSession#logError(java.lang.Exception)
   */
  @Override
  ...
  private void cleanup(IncomingMessage incomingMessage)
  {
    ...
    for (File file : message.getFiles())
    {
      ...
      {
        // this is not the data file itself (the inbox is not transparent)
